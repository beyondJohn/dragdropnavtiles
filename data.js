var tiles = {
    ada: { text: 'Accessibility', img: 'images/ada.svg', navtag: 'ada', imgtype: 'svg', class: 'full', type: 'single' },
    ...
    ps4: { text: 'PS4 Demos', img: 'images/ps4demos.svg', navtag: 'ps4', imgtype: 'svg', class: 'full', type: 'single' },
    ps_vr: { text: 'PS VR Demos', img: 'images/psvrdemos.svg', navtag: 'ps vr', imgtype: 'svg', class: 'full', type: 'single' },
    theaters: { text: 'Theaters', img: 'fa fa-film fa-5x', navtag: 'theater', imgtype: 'fa', class: 'full', type: 'single' },
    tournament: { text: 'Tournaments', img: 'images/tournaments.svg', navtag: 'tournaments', imgtype: 'svg', class: 'full paddingsm', type: 'single' },
    info: { text: 'Information', img: 'images/info.svg', navtag: 'info', imgtype: 'svg', class: 'full paddingsm', type: 'single' },
    autographs: { text: 'Autographs', img: 'images/autographs.svg', navtag: 'autographs', imgtype: 'svg', class: 'full paddingsm', type: 'single' },
    ...
    latam_conference_rooms: { text: 'LATAM Conference Rooms', img: 'images/LATAM.svg', navtag: 'latamconfrooms', imgtype: 'svg', class: 'full paddingsm' }
}
